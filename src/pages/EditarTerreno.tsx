...
export function EditarTerreno() {
  ...
  // ---- Planta do imóvel (confrontantes) ----
  ...
  return (
    <Layout>
      ...
      {/* Planta do imóvel / confrontantes -- seção independente do
          formulário acima: tem seu próprio fluxo de upload+extração+
          confirmação, sem depender de "Salvar alterações". */}
      ...
      {/* Memorial descritivo -- só um documento anexado, sem extração. */}
      <section className="mt-6 rounded-xl2 bg-white p-6 shadow-card">
